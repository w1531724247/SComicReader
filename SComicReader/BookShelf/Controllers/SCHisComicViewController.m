//
//  SCCollectionComicViewController.m
//  SComicReader
//
...
@interface SCHisComicViewController ()
@end

@implementation SCHisComicViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSArray *comicDicts = [defaults objectForKey:@"history_comics"];
...
-(void)didClickDeleteButton:(UIButton *)sender withKey:(NSString *)key{
    [super didClickDeleteButton:sender withKey:@"history_comics"];
}
